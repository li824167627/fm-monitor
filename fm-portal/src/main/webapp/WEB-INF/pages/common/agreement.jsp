...
<body>
<style type="text/css">p.p1 {margin: 0.0px 0.0px 0.0px 0.0px; text-align: justify; line-height: 15.0px; font: 14.5px Helvetica; color: #636363}
p.p2 {margin: 0.0px 0.0px 0.0px 0.0px; line-height: 19.2px; font: 12.0px Helvetica; color: #636363}
p.p3 {margin: 0.0px 0.0px 0.0px 0.0px; line-height: 15.0px; font: 14.5px Helvetica; color: #636363}
p.p4 {margin: 0.0px 0.0px 0.0px 0.0px; text-align: justify; font: 12.0px 'Times New Roman'; min-height: 15.0px}
span.s1 {font-kerning: none}
span.s2 {font: 16.0px 'Times New Roman'; color: #000000}
span.Apple-tab-span {white-space:pre}</style>
<p class="p1" style="text-align: center;">
    <strong>用户使用协议</strong>
</p>
<p class="p1">
    1. 特别提示
</p>
...
<p class="p2">
    1.3浩安瑞普(北京)科技有限公司（以下称“本公司”）同意按照本协议的规定及其不时发布的操作规则提供基于互联网的相关服务（以下称&quot;本服务&quot;）。为获得本服务，服务使用人（以下称&quot;用户&quot;）应当同意本协议的全部条款并按照页面上的提示完成全部的申请程序。
</p>
<p class="p1">
    2. 协议的范围
</p>
...
<p class="p2">
    本协议内容同时包括浩安瑞普(北京)科技有限公司可能不断发布的关于本服务的相关协议、业务规则等内容。上述内容一经正式发布，即为本协议不可分割的组成部分，您同样应当遵守。
</p>
<p class="p3">
    <span class="s1">3.服务内容与授权使用范围</span>
</p>
<p class="p2">
    <span class="s1">3.1本软件根据用户实际需求提供服务，门禁申请，门禁发放等。</span>
</p>
<p class="p2">
    <span class="s1">3.2本软件手机应用的授权使用范围：</span>
</p>
<p class="p2">
    <span class="s1">1) 用户可以在手机上安装、使用、显示、运行本软件。</span>
</p>
<p class="p2">
    <span class="s1">2) 保留权利：未明示授权的其他一切权利均由本公司所有。</span>
</p>
<p class="p1">
    4. 使用规则
</p>
...
<p class="p2">
    6) 如发现任何非法使用用户账号或账号出现安全漏洞的情况，应立即通告浩安瑞普(北京)科技有限公司官方；
</p>
<p class="p2">
    7) 不使用外挂或者其他作弊手段、不正当或不公平手段参加本软件提供的本服务。
</p>
<p class="p2">
    4.2.2浩安瑞普(北京)科技有限公司致力于为用户提供文明健康、规范有序的服务，用户应遵守中华人民共和国相关法律法规(如果用户是中华人民共和国境外的使用者，还应遵守所属国家或地区的法律法规)
</p>
<p class="p3">
    <span class="s1">. 知识产权</span>
</p>
<p class="p2">
    <span class="s1">5.1本公司是本软件的知识产权权利人。本软件的一切著作权、商标权、专利权、商业秘密等知识产权，以及与本软件相关的所有信息内容（包括但不限于视频课件、文字、图片、音频、图表、界面设计、版面框架、有关数据或电子文档等）均受中华人民共和国法律法规和相应的国际条约保护，本公司享有上述知识产权，除非事先经本公司的合法授权，任何人皆不得擅自以任何形式使用，否则本公司可立即终止向该用户提供产品和服务，并依法追究其法律责任，赔偿本公司的一切损失。</span>
</p>
<p class="p2">
    <span class="s1">5.2 用户只有在获得本公司或其他相关权利人的授权之后才能使用这些内容，而不能擅自复制、再造这些内容、或创造与内容有关的派生产品。</span>
</p>
<p class="p2">
    <span class="s1">5.3 用户原创作品上载、传送、输入或以其他方式提供至本软件手机应用时，视为用户授予本软件手机应用对其作品的使用权，该授权无地域、期限、方式限制，该授权为免费授权，本软件手机应用可在现行法律范围内就该作品进行使用，包括但不限于复制、发行、出租、展览、表演、放映、广播、信息网络传播、摄制、改编、翻译、汇编等，并可将前述权利转、分授权给其他第三方。</span>
</p>
<p class="p2">
    <span class="s1">5.4用户在本软件上发布的信息不得侵犯任何第三人的知识产权，未经相关权利人之事先书面同意，用户不得以任何方式上传、发布、修改、传播或复制任何受著作权保护的材料、商标或属于其他人的专有信息。</span>
</p>
<p class="p1">
    6. 隐私保护
</p>
...
<p class="p1">
    <span class="s2"><strong><span class="Apple-tab-span"></span></strong></span>8. 服务变更、中断或终止
</p>
<p class="p2">
    8.1软件更新
</p>
<p class="p2">
    8.1.1为了改善用户体验、完善服务内容，本公司将不断努力开发新的服务，并为您不时提供软件更新（这些更新可能会采取软件替换、修改、功能强化、版本升级等形式）。
</p>
<p class="p2">
    8.1.2为了保证本软件及服务的安全性和功能的一致性，本公司有权不经向您特别通知而对软件进行更新，或者对软件的部分功能效果进行改变或限制。本软件新版本发布后，旧版本的软件可能无法使用。本公司不保证旧版本软件继续可用及相应的客户服务，请您随时核对并下载最新版本。
</p>
<p class="p2">
